...
(function ( $ ) {
    	...
    	if(color == undefined) {
			...
			$.each(array, function(date,events) {
				...
				$.each(events, function(ev,evdata) {
					...
					tempeventarray["link"] = evdata.link;
	...
	var tocalendar = function() {
		...
		for(var o = 0; o<ev.length;o++) {
			$(".specific-day-scheme").append('<div class="specific-day-scheme-event"><h1>'+ev[o]['name']+'</h1><p data-role="dur">'+ev[o]['start']+' - '+ev[o]['end']+'</p><p data-role="loc">'+ev[o]['location']+'</p><p data-role="link"><a href="'+ev[o]['link']+'"> Leia mais</a>"</p></div>');
		}
		}
	}
